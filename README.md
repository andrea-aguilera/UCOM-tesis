...
**Procesamiento del Lenguaje Natural en Salud Mental**: Extracción de prescripciones y modelo de análisis de sentimiento en consultas psiquiátricas de pacientes con diagnóstico de depresión en el sistema público de salud público en Paraguay
